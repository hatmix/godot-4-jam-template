...
## For anything that needs to be positioned relative to a game object, this fuction takes a Rect2
## and returns the Vector2 offset needed to position it fully inside the visible viewport.
